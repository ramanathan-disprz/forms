...
public class FormService : IFormService
{
    ...
    private void CreateFormQuestions(Form form, IEnumerable<FormQuestionRequest> questionRequests)
    {
    ...
    private void UpdateFormQuestions(Form form, IEnumerable<FormQuestionRequest> questionRequests)
    {
        string? formId = form.Id;
        if (formId == null)
            return;
